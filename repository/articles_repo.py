...
from dtos.articles import ArticleReadable, ArticleSummary 
from dtos.articles.full_article import ArticleReadable , TextBlock , ImageBlock
...
class MockArticlesRepository:
    @lru_cache(maxsize=1)
    def get_article_by_id(self, _id = 1) -> ArticleReadable:
