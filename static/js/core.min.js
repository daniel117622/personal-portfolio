 ...
 * @version      1.0.0
 */
(function(){var t,e,i,a,o;t=window.jQuery,e=document,i=window,navigator.appVersion.indexOf("MSIE"),o="ontouchstart"in i,a=function(){function a(a,o){this.options=t.extend(!0,{},this.Defaults,o),this.element=a,this.$element=t(a),this.state=0,this.$win=t(i),this.$doc=t(e),this.classes={playPause:"rd-audio-play-pause",stopButton:"rd-audio-stop",nextButton:"rd-audio-next",prevButton:"rd-audio-prev",volume:"rd-audio-volume",volumeBar:"rd-audio-volume-bar",volumeBarSlider:"rd-audio-volume-bar-slider",progressBar:"rd-audio-progress-bar",progressBarSlider:"rd-audio-progress-bar-slider",duration:"rd-audio-duration",currentTime:"rd-audio-current-time",playlist:"rd-audio-playlist",author:"rd-audio-author",title:"rd-audio-title"},this.initialize()}return a.prototype.Defaults={src:"audio/sound_1.mp3",volumeBarType:"horizontal",playListName:"",author:"",title:"",autoplay:!1,loop:!1},a.prototype.initialize=function(){this.createDataApi(),this.createAudio(),this.createProgressBar(),this.createVolumeBar(),this.updateState(this),this.attachPlayerEvents(),this.attachPlayPauseButtonListener(),this.attachVolumeButtonListener(),this.attachStopButtonListener(),this.initPlaylistClickListener(),this.triggerPlaylistClick(),this.attachNextTrackButtonListener(),this.attachPrevTrackButtonListener(),this.updateDuration(),this.updateAuthorName(),this.updateTitle()},a.prototype.createAudio=function(){this.audio=new Audio,this.$element.append(this.audio),0===this.options.playListName.length&&(this.loadTrack(this.options.src),this.getOption("autoplay")&&this.audio.play())},a.prototype.updateState=function(t){var e;e=t.isErrored()?0:t.isLoading()?1:2,t.state!==e&&(t.state=e)},a.prototype.attachPlayPauseButtonListener=function(){var t;(t=this).$element.find("."+t.classes.playPause).on("click",function(e){e.preventDefault(),2===t.state&&null==t.playListName&&(t.isPlaying()?t.audio.pause():t.audio.play()),t.$doc.trigger("playlistClick",[t.playListName,t.index])})},a.prototype.attachStopButtonListener=function(){var t;(t=this).$element.find("."+t.classes.stopButton).on("click",function(e){e.preventDefault(),t.audio.currentTime=0,t.$doc.trigger("playlistClick",[t.playListName,t.index])})},a.prototype.updateDuration=function(){var t,e;(e=(t=this).$element.find("."+t.classes.duration)[0])&&t.audio.addEventListener("durationchange",function(){var i,a;return i=t.getDuration(),a=("0"+Math.floor(i)).slice(-2),i=("0"+Math.floor(a/60%60)).slice(-2),e.innerHTML=i+":"+Math.floor(a)})},a.prototype.updateAuthorName=function(){var t,e;(t=(e=this).$element.find("."+e.classes.author)[0])&&e.audio.addEventListener("durationchange",function(){var i;return i=e.playListName?(i=e.$doc.find('[data-rd-audio-playlist="'+e.playListName+'"]:not(.'+e.classes.playlist+') li[data-index="'+e.index+'"]'))[0].getAttribute("data-rd-audio-author"):e.options.author,t.innerHTML=i})},a.prototype.updateTitle=function(){var t,e;(e=(t=this).$element.find("."+t.classes.title)[0])&&t.audio.addEventListener("durationchange",function(){var i;return i=t.playListName?(i=t.$doc.find('[data-rd-audio-playlist="'+t.playListName+'"]:not(.'+t.classes.playlist+') li[data-index="'+t.index+'"]'))[0].getAttribute("data-rd-audio-title"):t.options.title,e.innerHTML=i})},a.prototype.updateCurrentTime=function(t){var e,i;i=("0"+Math.floor(this.audio.currentTime)).slice(-2),e=("0"+Math.floor(i/60%60)).slice(-2),t.innerHTML=e+":"+i},a.prototype.attachVolumeButtonListener=function(){var t;(t=this).$element.find("."+t.classes.volume).on("click",function(e){e.preventDefault(),t.audio.muted=!t.isMuted()})},a.prototype.attachNextTrackButtonListener=function(){var t;(t=this).$element.find("."+t.classes.nextButton).on("click",function(e){e.preventDefault(),e=t.$doc.find('[data-rd-audio-playlist="'+t.playListName+'"] li[data-index="'+(parseInt(t.index)+1)+'"]').length?[t.playListName,parseInt(t.index)+1]:[t.playListName,0],t.$doc.trigger("playlistClick",e)})},a.prototype.attachPrevTrackButtonListener=function(){var t;(t=this).$element.find("."+t.classes.prevButton).on("click",function(e){e.preventDefault(),0<=parseInt(t.index)-1?e=[t.playListName,parseInt(t.index)-1]:(e=t.$doc.find('[data-rd-audio-playlist="'+t.playListName+'"]'),e=[t.playListName,e.eq(e.length-1).find("li").last().attr("data-index")]),t.$doc.trigger("playlistClick",e)})},a.prototype.removeStateClass=function(t){var e,i,a,o;for(a=0,o=(i=t.element.className.split(/\s+/)).length;a<o;a++)-1!==(e=i[a]).indexOf("state-")&&t.element.classList.remove(e)},a.prototype.createProgressBar=function(){var i,a,n,r;(n=this).$element.find("."+n.classes.progressBar).length&&(n.currentProgress=r=e.createElement("div"),r.classList.add("current"),n.attachProgressBarSlider(),i=n.$element.find("."+n.classes.progressBar)[0],a=!1,t(i).on("mousedown.rd touchstart.rd",function(t){(1===t.which||o)&&(a=!0,n.audio.currentTime=n.getClickBarPosition(t,i,"horizontal")*n.getDuration(),n.$doc.on("mouseup.rd touchend.rd touchcancel.rd",function(t){if(a)return a=!1}),n.$doc.on("mousemove.rd touchmove.rd",function(t){a&&(n.audio.currentTime=n.getClickBarPosition(t,i,"horizontal")*n.getDuration())}))}),i.appendChild(r))},a.prototype.attachProgressBarSlider=function(){var t;(t=this).$element.find("."+t.classes.progressBarSlider).length&&(t.progressSlider=t.$element.find("."+t.classes.progressBarSlider)[0]),t.audio.addEventListener("seeked",function(){return t.progressSlider.style.left=t.audio.currentTime/t.getDuration()*100+"%"})},a.prototype.createVolumeBar=function(){var i,a,n,r;(n=this).$element.find("."+n.classes.volumeBar).length&&(n.currentVolume=r=e.createElement("div"),r.classList.add("current"),r.style.width=100*n.audio.volume+"%",n.attachVolumeBarSlider(),i=n.$element.find("."+n.classes.volumeBar)[0],n.getOption("volumeBarType")&&i.classList.add("rd-audio-volume-bar-"+n.getOption("volumeBarType")),a=!1,t(i).on("mousedown.rd touchstart.rd",function(t){(1===t.which||o)&&(a=!0,n.audio.volume=n.getClickBarPosition(t,i,n.getOption("volumeBarType")),n.isMuted()&&(n.audio.muted=!1),n.$doc.on("mouseup.rd touchend.rd touchcancel.rd",function(t){if(a)return a=!1}),n.$doc.on("mousemove.rd touchmove.rd",function(t){a&&(1===t.which||o)&&(n.audio.volume=n.getClickBarPosition(t,i,n.getOption("volumeBarType")),n.isMuted()&&(n.audio.muted=!1))}))}),i.appendChild(r))},a.prototype.attachVolumeBarSlider=function(){var t;(t=this).$element.find("."+t.classes.volumeBarSlider).length&&(t.volumeBarSlider=t.$element.find("."+t.classes.volumeBarSlider)[0]),t.audio.addEventListener("volumechange",function(){return"horizontal"===t.getOption("volumeBarType")?t.isMuted()?t.volumeBarSlider.style.left="0":t.volumeBarSlider.style.left=100*t.audio.volume+"%":"vertical"===t.getOption("volumeBarType")?t.isMuted()?t.volumeBarSlider.style.bottom="0":t.volumeBarSlider.style.bottom=100*t.audio.volume+"%":void 0})},a.prototype.playlistPlayPause=function(t,e){null!=e&&e?(this.audio.play(),t.addClass("playing")):!1===e?(this.audio.pause(),t.addClass("paused")):this.isPlaying()?(this.audio.pause(),t.addClass("paused")):(this.audio.play(),t.addClass("playing"))},a.prototype.initPlaylistClickListener=function(){var t;(t=this).$element.find("."+t.classes.playlist).length&&(t.playlist=t.$element.find("."+t.classes.playlist)[0]),null==t.index&&(t.index=-1),t.$doc.on("playlistClick",function(e,i,a,o){t.clearPlayListClasses(),(e=t.$doc.find('[data-rd-audio-playlist="'+i+'"] li[data-index="'+a+'"]')).length&&(null!=t.playListName&&t.playListName===i?null!=t.index&&t.index===a?t.playlistPlayPause(e):(t.loadTrack(e[0].getAttribute("data-rd-audio-src")),t.playlistPlayPause(e,!0),t.index=a):(t.playListName=i,t.index=a,t.loadTrack(e[0].getAttribute("data-rd-audio-src")),null==o||o?(t.addToPlaylist(t,i,a,!0),t.playlistPlayPause(e,!0)):(t.addToPlaylist(t,i,a,!1),t.playlistPlayPause(e,!1))))})},a.prototype.triggerPlaylistClick=function(){var i,a,o,n,r;for(r=(i=this).$doc.find("[data-rd-audio-playlist]"),i.setPlaylistIndexes(r),a=0,o=r.length;a<o;a++)n=r[a],t(n).find(n.getAttribute("data-rd-audio-play-on")).on("click",function(i){var a;return a=t(this),"A"===this.tagName&&i.preventDefault(),i=a.parents("[data-index]").length?a.parents("[data-index]").attr("data-index"):this.getAttribute("data-index"),a=[a.parents("[data-rd-audio-playlist]").attr("data-rd-audio-playlist"),parseInt(i)],t(e).trigger("playlistClick",a)});null!=i.playlist&&i.$doc.delegate("."+i.classes.playlist+" li","click",function(){var t;return t=parseInt(this.getAttribute("data-index")),i.$doc.trigger("playlistClick",[i.playListName,t])}),i.options.playListName&&(i.index=0,a=[i.options.playListName,0,i.getOption("autoplay")],i.$doc.trigger("playlistClick",a))},a.prototype.loadTrack=function(t){this.audio.src=t,this.audio.load()},a.prototype.clearPlayListClasses=function(){this.$doc.find("[data-rd-audio-playlist] .paused").removeClass("paused"),this.$doc.find("[data-rd-audio-playlist] .playing").removeClass("playing")},a.prototype.setPlaylistIndexes=function(e){var i,a,o,n,r,s;for(r=[],i=[],a=0,n=e.length;a<n;a++)s=e[a],-1===r.indexOf(s.getAttribute("data-rd-audio-playlist"))?(o=r.length,r.push(s.getAttribute("data-rd-audio-playlist")),i.push(0)):o=r.indexOf(s.getAttribute("data-rd-audio-playlist")),t(s).find("li").each(function(){return this.setAttribute("data-index",i[o]),i[o]+=1})},a.prototype.addToPlaylist=function(e,i,a,o){var n;null!=(e=this).playlist&&(e.audio.pause(),n="",e.$doc.find('[data-rd-audio-playlist="'+i+'"]').each(function(){return t(this).find("li").each(function(){var t;return t="",parseInt(this.getAttribute("data-index"))===a&&(t=null==o||o?"playing":"paused"),n+='<li class="'+t+'" data-rd-audio-src="'+this.getAttribute("data-rd-audio-src")+'" data-index="'+this.getAttribute("data-index")+'">',n+='<span class="song-author">'+this.getAttribute("data-rd-audio-author")+"</span> - ",n+='<span class="song-title">'+this.getAttribute("data-rd-audio-title")+"</span>",n+="</li>"})}),e.playlist.setAttribute("data-rd-audio-playlist",i),e.playlist.innerHTML=n)},a.prototype.attachPlayerEvents=function(){var t,e,i;t=(e=this).audio,i=e.$element.find("."+e.classes.currentTime),t.addEventListener("canplay",function(){if(e.element.classList.remove("state-loading"),i.length&&e.updateCurrentTime(i[0]),null!=e.volumeBarSlider){if("horizontal"===e.getOption("volumeBarType"))return e.volumeBarSlider.style.left=100*e.audio.volume+"%";if("vertical"===e.getOption("volumeBarType"))return e.volumeBarSlider.style.bottom=100*e.audio.volume+"%"}}),t.addEventListener("canplaythrough",function(){return e.element.classList.remove("state-loading")}),t.addEventListener("play",function(){return e.removeStateClass(e),e.element.classList.add("state-playing")}),t.addEventListener("playing",function(){return e.removeStateClass(e),e.element.classList.add("state-playing")}),t.addEventListener("pause",function(){return e.removeStateClass(e),e.element.classList.add("state-pause")}),t.addEventListener("ended",function(){var t;return e.options.loop?(e.audio.currentTime=0,e.audio.play()):null!=e.playlist?(t=e.$doc.find('[data-rd-audio-playlist="'+e.playListName+'"] li[data-index="'+(parseInt(e.index)+1)+'"]').length?[e.playListName,parseInt(e.index)+1]:[e.playListName,0],e.$doc.trigger("playlistClick",t)):void 0}),t.addEventListener("volumechange",function(){if(e.isMuted()||0===e.audio.volume){if(e.element.classList.add("muted"),"horizontal"===e.getOption("volumeBarType"))return e.currentVolume.style.width=0;if("vertical"===e.getOption("volumeBarType"))return e.currentVolume.style.height=0}else{if(e.element.classList.remove("muted"),"horizontal"===e.getOption("volumeBarType"))return e.currentVolume.style.width=100*e.audio.volume+"%";if("vertical"===e.getOption("volumeBarType"))return e.currentVolume.style.height=100*e.audio.volume+"%"}}),t.addEventListener("timeupdate",function(){var a;if(null!=e.currentProgress&&(a=t.currentTime/e.getDuration()*100+"%",e.currentProgress.style.width=a),null!=e.progressSlider&&(e.progressSlider.style.left=a),i.length)return e.updateCurrentTime(i[0])}),t.addEventListener("loadstart",function(){return e.removeStateClass(e),e.element.classList.add("state-loading")}),t.addEventListener("waiting",function(){return e.removeStateClass(e),e.element.classList.add("state-loading")})},a.prototype.getClickBarPosition=function(t,e,i){return t.preventDefault(),"horizontal"===i?(i=e.getBoundingClientRect().left,e=e.clientWidth,t.originalEvent&&(t=t.originalEvent),t=o?t.targetTouches[0].pageX:t.pageX,Math.min(1,Math.max(0,(t-i)/e))):"vertical"===i?(i=e.getBoundingClientRect().bottom,e=e.clientHeight,t.originalEvent&&(t=t.originalEvent),t=o?t.targetTouches[0].pageY:t.pageY,Math.min(1,Math.max(0,(i-t)/e))):void 0},a.prototype.isPlaying=function(){return this.audio&&!this.audio.paused},a.prototype.isPaused=function(){return this.audio&&this.audio.paused},a.prototype.isMuted=function(){return this.audio.muted},a.prototype.isLoading=function(){return!(!this.state&&this.isEmpty())&&this.audio.networkState===this.audio.NETWORK_LOADING&&this.audio.readyState<this.audio.HAVE_FUTURE_DATA},a.prototype.isErrored=function(){return this.audio.error||this.audio.networkState===this.audio.NETWORK_NO_SOURCE},a.prototype.isEmpty=function(){return this.audio.readyState===this.audio.HAVE_NOTHING},a.prototype.getDuration=function(){return this.audio.duration},a.prototype.createDataApi=function(){this.$element.attr("data-rd-audio-src")&&(this.options.src=this.$element.attr("data-rd-audio-src")),this.$element.attr("data-rd-volume-bar-type")&&(this.options.volumeBarType=this.$element.attr("data-rd-volume-bar-type")),this.$element.attr("data-rd-audio-playlist-name")&&(this.options.playListName=this.$element.attr("data-rd-audio-playlist-name")),this.$element.attr("data-rd-audio-author")&&(this.options.author=this.$element.attr("data-rd-audio-author")),this.$element.attr("data-rd-audio-title")&&(this.options.title=this.$element.attr("data-rd-audio-title")),this.$element.attr("data-rd-audio-autoplay")&&(this.options.autoplay="true"===this.$element.attr("data-rd-audio-autoplay")),this.$element.attr("data-rd-audio-loop")&&(this.options.loop="true"===this.$element.attr("data-rd-audio-loop"))},a.prototype.getOption=function(t){var e,a;for(e in this.options.responsive)e<=i.innerWidth&&(a=e);return null!=this.options.responsive&&null!=this.options.responsive[a][t]?this.options.responsive[a][t]:this.options[t]},a}(),t.fn.extend({RDAudio:function(e){return this.each(function(){var i;if(!(i=t(this)).data("RDAudio"))return i.data("RDAudio",new a(this,e))})}}),i.RDAudio=a,"undefined"!=typeof module&&null!==module?module.exports=window.RDAudio:"function"==typeof define&&define.amd&&define(["jquery"],function(){return window.RDAudio})}).call(this);
